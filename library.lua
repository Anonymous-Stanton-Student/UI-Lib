...
local drawing  = loadstring(syn.request({Url = 'https://raw.githubusercontent.com/Anonymous-Stanton-Student/UI-Lib/main/drawing.lua', Method = 'GET'}).Body)()
local tween = loadstring(syn.request({Url = 'https://raw.githubusercontent.com/Anonymous-Stanton-Student/UI-Lib/main/tween.lua', Method = 'GET'}).Body)()
